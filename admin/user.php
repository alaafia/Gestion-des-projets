...
<body>
	...
	<div id = "content">
		<br /><br /><br />
		<div class="alert alert-info"><h3>Liste d'enseignants</h3></div> 
		<button class="btn btn-success" data-toggle="modal" data-target="#form_modal"><span class="glyphicon glyphicon-plus"></span> ajouter un enseignant</button>
		<br /><br />
			...
			<tbody>
				...
				?>	
					<tr class="del_user<?php echo $fetch['user_id']?>">
						...
						<td><center><button class="btn btn-warning" data-toggle="modal" data-target="#edit_modal<?php echo $fetch['user_id']?>"><span class="glyphicon glyphicon-edit"></span> modifier</button> 
						<?php
							...
							<div class="modal-content">
								<form method="POST" action="update_user.php">	
									...
									<div class="modal-footer">
										...
										<button name="edit" class="btn btn-warning" ><span class="glyphicon glyphicon-save"></span> modifier</button>
									</div>
								</form>
							</div>
						</div>
